class Bestellung:
    ...
    def preluare_comanda(self,id,lista):
        ...
        self.id=id
        ok=0
        with open("users.txt", 'r') as f:  # modificam in fisier
            lines = f.readlines()
            for line in lines:
                line_sep = line.split(' ')
    ...
    def output_bestellung(self, list):
        """
    ...
    def search_actors(self, l, actor):
        ...
        with open("filme.txt",'r') as f:
            ...
            for line in lines:
                ...
                line_sep = line.split(',') #obtin lista de actori din fiecare film
                n = len(line_sep) - 1
                i = 1
